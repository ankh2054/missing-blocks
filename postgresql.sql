...
-- Grant privileges to the postgres user first
GRANT ALL PRIVILEGES ON DATABASE missingwax TO CURRENT_USER;
GRANT ALL PRIVILEGES ON SCHEMA missingwax TO CURRENT_USER;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA missingwax TO CURRENT_USER;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA missingwax TO CURRENT_USER;